...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 15, 8, 233);
    			add_location(li, file$3, 13, 4, 200);
    			add_location(main, file$3, 12, 0, 189);
    		},
    ...
    class TodoItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { todoItems: 2, index: 3, toggleItem: 4 });
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$2, 10, 8, 213);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(8:4) {#if todoItems.length == 0}",
    		ctx
    	});
    ...
    // (12:12) {#each todoItems as item, index (item.id)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(12:12) {#each todoItems as item, index (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			add_location(main, file$2, 6, 0, 105);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class TodoList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { todoItems: 0, toggleItem: 1 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-gbwyk5");
    			add_location(input, file$1, 18, 8, 354);
    			attr_dev(button0, "type", "submit");
    			button0.disabled = /*textEmpty*/ ctx[4];
    			add_location(button0, file$1, 19, 8, 503);
    			attr_dev(button1, "type", "button");
    			button1.disabled = button1_disabled_value = /*completedCount*/ ctx[1] == 0;
    			add_location(button1, file$1, 20, 8, 584);
    			add_location(form, file$1, 17, 4, 306);
    			add_location(br, file$1, 23, 4, 707);
    			add_location(main, file$1, 16, 0, 295);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
